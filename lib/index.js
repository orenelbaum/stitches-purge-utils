...
;(async () => {
    {
        const sourceFilePaths = await getFiles(options.srcDir)
            ...
            sourceFilePaths.map(sourceFilePath =>
                transformFileAsync(
                    sourceFilePath,
                    {
                        ...
                        plugins: [
                            [
                                "./node_modules/stitches-purge-utils/lib/scan-util-usage.babel-plugin.js",
                                {
                                    CSSPropertySet,
            ...
            transformFileAsync(
                ...
                { 
                    plugins: [
                        ...
                        ["./node_modules/stitches-purge-utils/lib/transform-utils.babel-plugin.js", { CSSPropertySet }]
                    ],
                    configFile: false
                }
            ).then(purgedUtilFile => {
